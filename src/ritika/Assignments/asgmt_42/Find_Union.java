...
public class Find_Union {
	...
	void findUnion(ArrayList<String> al1, ArrayList<String> al2) {
		...
		for (int i = 0; i < al2.size(); i++) {
			...
			while (al2.indexOf(temp) != al2.lastIndexOf(temp)) {
				al2.remove(al2.lastIndexOf(temp));
			}
		}		
		al2.removeAll(al1);
		al1.addAll(al2);
		System.out.println("Union of both lists is:");
	...
	public static void main(String[] args) {
		...
		Find_Union findUnion = new Find_Union();
		findUnion.findUnion(al1, al2);
	}
}
