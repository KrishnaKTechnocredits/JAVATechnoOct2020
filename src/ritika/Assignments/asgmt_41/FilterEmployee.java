...
public class FilterEmployee {
	...
	public List<String> filterEmployeeBySalary(List<Employee> employeeDetails) {
...
/*
	...
	public static void main(String[] args) {
		...
		FilterEmployee filter1 = new FilterEmployee();
		System.out.println(filter1.filterEmployeeBySalary(employeeDetails));
	}
}
