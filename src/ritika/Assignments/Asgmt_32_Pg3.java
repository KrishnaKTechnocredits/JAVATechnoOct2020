...
public class Asgmt_32_Pg3 {
	...
	char returnCharOfAscii(int ascii) {
	...
	public static void main(String[] args) {
		Asgmt_32_Pg3 program3 = new Asgmt_32_Pg3();
		System.out.println("Ascii value of given character is: " + program3.returnAsciiOfCharacter('G'));
		System.out.println();
		System.out.println("Character of given Ascii value is: " + program3.returnCharOfAscii(80));
		System.out.println();
