...
/* Program 1 : Retains all common names between both list. */
import java.util.ArrayList;
public class Program1RetainAll {
	...
	public static void main(String[] args) {
		...
		aL2.add("Rahul");
		aL2.add("Prasad");
		System.out.println("Common Names in both list : "+new Program1RetainAll().retainAllCommonNames(aL1, aL2));
	}
}
