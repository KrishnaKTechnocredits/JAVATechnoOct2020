...
public class DisplaySalaryLessThanActual {
	...
	public static void main(String[] args) {
		...
		DisplaySalaryLessThanActual emp1 = new DisplaySalaryLessThanActual("Anjali", "Dewesh", "Shukla", "Testing",
				1026, 101, 25, 25000);
		DisplaySalaryLessThanActual emp2 = new DisplaySalaryLessThanActual("Shweta", "Abhay", "Parmar", "Testing", 1026,
				102, 26, 31000);
		DisplaySalaryLessThanActual emp3 = new DisplaySalaryLessThanActual("Vinayak", "Shirish", "Vyas", "Testing",
				1026, 103, 24, 32000);
		empDetails.add(emp1);
		empDetails.add(emp2);
		empDetails.add(emp3);
