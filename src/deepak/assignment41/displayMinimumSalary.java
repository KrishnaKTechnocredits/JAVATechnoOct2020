...
public class displayMinimumSalary {
	...
	public static void main(String[] args) {
		...
		displayMinimumSalary emp1 = new displayMinimumSalary("Amit", "Suresh", "Aphale", "Testing", 1026, 101, 25,
				25000);
		displayMinimumSalary emp2 = new displayMinimumSalary("Deepak", "Kisan", "Latad", "Testing", 1026, 102, 26,
				30000);
		displayMinimumSalary emp3 = new displayMinimumSalary("Aditya", "Harish", "Thakare", "Testing", 1026, 103, 24,
				22000);
		empDetails.add(emp1);
		empDetails.add(emp2);
		empDetails.add(emp3);
