...
public class DisplayAgeAndSalary {
	...
	public static void main(String[] args) {
		...
		DisplayAgeAndSalary emp1 = new DisplayAgeAndSalary("Amit", "Suresh", "Aphale", "Testing", 1026, 101, 30,
				25000);
		DisplayAgeAndSalary emp2 = new DisplayAgeAndSalary("Deepak", "Kisan", "Latad", "Testing", 1026, 102, 28,
				76000);
		DisplayAgeAndSalary emp3 = new DisplayAgeAndSalary("Aditya", "Harish", "Thakare", "Testing", 1026, 103, 32,
				32000);
		empDetails.add(emp1);
		empDetails.add(emp2);
		empDetails.add(emp3);
