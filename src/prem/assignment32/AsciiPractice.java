...
public class AsciiPractice {
	...
	*/
		...
		public static void main(String[] args) {
			AsciiPractice asciiPractice = new AsciiPractice();
			asciiPractice.charToAscii('A');
			asciiPractice.asciiToChar(119);
			asciiPractice.asciiOfUpperCase();
			asciiPractice.asciiOfLowerCase();
		}
