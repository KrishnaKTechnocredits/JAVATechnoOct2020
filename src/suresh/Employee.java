...
public class Employee {
	...
	public static void main(String[] args) {
		Employee employee1 = new Employee("Suresh", "Chukka", 30, 123, 1586,500000, "Department1");
		Employee employee2 = new Employee("Praveen", "Chandra", 31, 121, 1587,800000, "Department2");
		Employee employee3 = new Employee("Siva", "killampally", 28, 124, 1586,200000, "Department1");
		Employee employee4 = new Employee("sunitha", "Madhuri", 34, 125, 1587,400000, "Department2");
