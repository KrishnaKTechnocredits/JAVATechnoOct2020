...
public class Assignment28 {
	...
	public static void main(String[] args) {
		...
		assignment28.findTripletWithMaximumSum(input1);
		assignment28.findTripletWithMaximumSum(input2);
		assignment28.findTripletWithMaximumSum(input3);
		assignment28.findTripletWithMaximumSum(input4);
		assignment28.findTripletWithMaximumSum(input5);
	}
}
