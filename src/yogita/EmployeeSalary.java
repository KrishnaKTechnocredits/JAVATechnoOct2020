...
public class EmployeeSalary {
	...
	public static void main(String[] args) {
		...
		EmployeeSalary emp1 = new EmployeeSalary("Yogita", "Pawale", 26, 101, 50000);
		EmployeeSalary emp2 = new EmployeeSalary("Pooja", "Pekhale", 25, 102, 60000);
		EmployeeSalary emp3 = new EmployeeSalary("Kajol", "patil", 28, 103, 28000);
		EmployeeSalary emp4 = new EmployeeSalary("Asmita", "Kulkarni", 30, 104, 25000);
		empDetails.add(emp1);
		empDetails.add(emp2);
		empDetails.add(emp3);
		empDetails.add(emp4);
