...
/*
 * 1) Read file and print total frequency of "Technocredits" word. 2) Read file
 * and print frequency of "Technocredits" word in each line.
 */
...
public class FileHandling {
	...
	public static void main(String[] args) throws FileNotFoundException {
		int totalCount = 0;
		Scanner scanner = new Scanner(new File("src//priyanka//assignment49(1)//techno.txt"));
