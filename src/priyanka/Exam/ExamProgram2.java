...
public class ExamProgram2 {
	...
	void findFequency(String str) {
		...
		System.out.println("In the given string there are :- Digits - " + digitCount + ", Letters- " + letterCount
				+ ", lowercase letters - " + lowerCaseCount + ", Uppercase letters - " + upperCaseCount
				+ ", Special charater - " + specialCount);
	}
