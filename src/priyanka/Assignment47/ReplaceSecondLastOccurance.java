...
public class ReplaceSecondLastOccurance {
	...
	void replaceSecondLastOccurance(String input) {
		...
		System.out.println(input.substring(0, index2) + subString2.replace("Hi", "Priyanka") + input.substring(index1));
	}

	public static void main(String[] args) {
		new ReplaceSecondLastOccurance().replaceSecondLastOccurance(
