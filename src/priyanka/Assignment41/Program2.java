...
public class Program2 {
	...
	/*
	 * Return a list of employee whose salary is less than 30000. Hint :
	 * List<Employee> filterEmployeeBySalary(List<Employee> listOfEmployee){}
	 */
	...
	public static void main(String[] args) {
		Employee employee1 = new Employee("Rohan", "Malhotra", 22, 12, 1586, 5000, "Department1");
		Employee employee2 = new Employee("Jay", "Kamath", 31, 121, 1587, 8000, "Department2");
