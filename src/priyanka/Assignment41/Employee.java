...
/*
Print all the details of employee having maximum salary.
...
public class Employee {
	...
	public Employee(String firstName, String lastName, int age, int empId, int empDeptId, int salary,
			String empDeptName) {
	...
	public static void main(String[] args) {
		Employee employee1 = new Employee("Jay", "Malhotra", 30, 123, 1586, 500000, "Department1");
		Employee employee2 = new Employee("Rohan", "Kamath", 29, 121, 1587, 950000, "Department2");
